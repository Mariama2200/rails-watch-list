puts " Cleaning lists and bookmarks..."

Bookmark.destroy_all
List.destroy_all

puts " Lists and bookmarks cleaned!"
puts " Movies kept in database"

# Only create movies if none exist (safety check)
if Movie.count.zero?
  ...
  puts " Movies already exist (#{Movie.count}), skipping creation."
end
